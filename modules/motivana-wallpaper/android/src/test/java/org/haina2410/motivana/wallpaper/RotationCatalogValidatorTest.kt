...
class RotationCatalogValidatorTest {
  private fun catalog() = RotationCatalog(
    (0 until 120).map { index -> RotationQuote("q$index", "A valid quote has more than twelve characters $index.", null, listOf("motivation", "discipline", "focus", "confidence", "growth", "success")[index % 6]) },
